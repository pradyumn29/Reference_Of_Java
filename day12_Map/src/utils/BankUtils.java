...
//add a static method to populate map of bank accounts -with sample data
	...
	public static BankAccount fetchAccountSummary(Map<Integer,BankAccount>acctMap,int AccNo) throws BankingException
	{
		BankAccount account=acctMap.get(AccNo);
	     if(account!=null)
	        ...
	        {	throw new BankingException(account.getAcctNo()+"is Dormant!!!");}
